  ...
  <section class="hero is-fullheight">
    <div class="columns hero-body is-fullheight is-centered">
      ...
      <div class="container p-4">
        ...
        <hr />
        <div style="position: absolute; left: 72.5%; top: 15%; width: 27.5%" class="has-background-light p-5 has-round">
        ...
        <div class="columns" style="top: 50px">
          <div class="column is-2 has-background-light">
            <img src="https://image.makewebeasy.net/makeweb/0/k7p5FZEpV/AC/4.png?v=202012190947"
              style="width: 150px; margin: 1em" alt="" />
          </div>
          ...
          <div class="column is-1">
            ...
            <button id="delete-button" class="delete" style="left: 110%; bottom: 21.5px"></button>
          </div>
